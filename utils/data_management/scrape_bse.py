...
class BSEBasisSetScraper:
    ...
    def add_filter(self, metadata_key: str, values: list) -> None:
        ...
        (
            self.filtered_basis_sets,
            self.filtered_metadata,
        ) = self.get_filtered_basis_sets()
...
def _write_basis_set(
    destination: str, basis_name: str, basis_data: str, extension: str
) -> None:
...
def main(args: argparse.Namespace) -> None:
    ...
    scraper = BSEBasisSetScraper(
        format=args.outformat, optimize_general=args.optimize_general
    )
    ...
    for name in scraper.filtered_basis_sets:
        ...
        _write_basis_set(
            args.destination, clean_name, text, scraper.get_extension()
        )
