    ...
    switch(Z) {
        case(1): {
            return atomic_basis_pt::wrap_results(
              rv, d_dash_aug_dash_cc_dash_pv6z_1());
        }
        case(5): {
            return atomic_basis_pt::wrap_results(
              rv, d_dash_aug_dash_cc_dash_pv6z_5());
        }
        case(6): {
            return atomic_basis_pt::wrap_results(
              rv, d_dash_aug_dash_cc_dash_pv6z_6());
        }
        case(7): {
            return atomic_basis_pt::wrap_results(
              rv, d_dash_aug_dash_cc_dash_pv6z_7());
        }
        case(8): {
            return atomic_basis_pt::wrap_results(
              rv, d_dash_aug_dash_cc_dash_pv6z_8());
        }
        default: {
