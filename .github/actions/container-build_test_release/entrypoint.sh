...
if [ "${USE_CLANG}" = true ]; then
   docker build -t ghcr.io/nwchemex-project/release_chemcache:clang-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_chemcache:clang-latest
else
   docker build -t ghcr.io/nwchemex-project/release_chemcache:gcc-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_chemcache:gcc-latest
fi
