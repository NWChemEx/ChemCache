...
aug-cc-pwcvdz atomic basis set
---------------------------------
...
MODULE_CTOR(aug_dash_cc_dash_pwcvdz_atom_basis) {
    description(module_desc);
    satisfies_property_type<atomic_basis_pt>();
}

MODULE_RUN(aug_dash_cc_dash_pwcvdz_atom_basis) {
    const auto& [Z] = atomic_basis_pt::unwrap_inputs(inputs);
    auto rv         = results();

    switch(Z) {
        case(5): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 5, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
        ...
        case(6): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 6, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(7): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 7, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(8): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 8, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(9): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 9, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(10): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 10, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(13): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 13, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(14): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 14, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(15): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 15, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(16): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 16, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(17): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 17, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(18): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz", 18, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
