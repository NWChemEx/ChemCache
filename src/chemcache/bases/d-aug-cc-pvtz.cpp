...
void load_d_dash_aug_dash_cc_dash_pvtz(chemist::BasisSetManager& bsm) {
    ...
    // Z = 1
    basis_map.emplace(
      1, chemist::AtomicBasisSet<double>("d-aug-cc-pvtz", 1, 0.0, 0.0, 0.0));
    ...
    // Z = 2
    basis_map.emplace(
      2, chemist::AtomicBasisSet<double>("d-aug-cc-pvtz", 2, 0.0, 0.0, 0.0));
    ...
    // Z = 5
    basis_map.emplace(
      5, chemist::AtomicBasisSet<double>("d-aug-cc-pvtz", 5, 0.0, 0.0, 0.0));
    ...
    // Z = 6
    basis_map.emplace(
      6, chemist::AtomicBasisSet<double>("d-aug-cc-pvtz", 6, 0.0, 0.0, 0.0));
    ...
    // Z = 7
    basis_map.emplace(
      7, chemist::AtomicBasisSet<double>("d-aug-cc-pvtz", 7, 0.0, 0.0, 0.0));
    ...
    // Z = 8
    basis_map.emplace(
      8, chemist::AtomicBasisSet<double>("d-aug-cc-pvtz", 8, 0.0, 0.0, 0.0));
    ...
    // Z = 9
    basis_map.emplace(
      9, chemist::AtomicBasisSet<double>("d-aug-cc-pvtz", 9, 0.0, 0.0, 0.0));
    ...
    // Z = 10
    basis_map.emplace(
      10, chemist::AtomicBasisSet<double>("d-aug-cc-pvtz", 10, 0.0, 0.0, 0.0));
