...
MODULE_RUN(aug_dash_cc_dash_pwcvdz_atom_basis) {
    ...
    switch(Z) {
        ...
        case(6): {
            return atomic_basis_pt::wrap_results(rv,
                                                 aug_dash_cc_dash_pwcvdz_6());
        }
        case(7): {
            return atomic_basis_pt::wrap_results(rv,
                                                 aug_dash_cc_dash_pwcvdz_7());
        }
        case(8): {
            return atomic_basis_pt::wrap_results(rv,
                                                 aug_dash_cc_dash_pwcvdz_8());
        }
        case(9): {
            return atomic_basis_pt::wrap_results(rv,
                                                 aug_dash_cc_dash_pwcvdz_9());
        }
        case(10): {
            return atomic_basis_pt::wrap_results(rv,
                                                 aug_dash_cc_dash_pwcvdz_10());
        }
        case(13): {
            return atomic_basis_pt::wrap_results(rv,
                                                 aug_dash_cc_dash_pwcvdz_13());
        }
        case(14): {
            return atomic_basis_pt::wrap_results(rv,
                                                 aug_dash_cc_dash_pwcvdz_14());
        }
        case(15): {
            return atomic_basis_pt::wrap_results(rv,
                                                 aug_dash_cc_dash_pwcvdz_15());
        }
        case(16): {
            return atomic_basis_pt::wrap_results(rv,
