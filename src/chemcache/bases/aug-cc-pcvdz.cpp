...
MODULE_RUN(aug_dash_cc_dash_pcvdz_atom_basis) {
    ...
    switch(Z) {
        case(3): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 3, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
        ...
        case(4): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 4, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(5): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 5, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(6): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 6, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(7): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 7, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(8): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 8, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(9): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 9, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(10): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 10, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(11): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 11, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(12): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 12, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(13): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 13, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(14): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 14, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(15): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 15, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(16): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 16, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(17): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 17, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(18): {
            atomic_basis_t atom_bs("aug-cc-pcvdz", 18, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
