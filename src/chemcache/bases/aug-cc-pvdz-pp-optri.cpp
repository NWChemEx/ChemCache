...
aug-cc-pvdz-pp-optri atomic basis set
---------------------------------
...
MODULE_CTOR(aug_dash_cc_dash_pvdz_dash_pp_dash_optri_atom_basis) {
    description(module_desc);
    satisfies_property_type<atomic_basis_pt>();
}

MODULE_RUN(aug_dash_cc_dash_pvdz_dash_pp_dash_optri_atom_basis) {
    const auto& [Z] = atomic_basis_pt::unwrap_inputs(inputs);
    auto rv         = results();

    // Basis Set name and origin point
    std::string name("aug-cc-pvdz-pp-optri");
