...
void load_six_dash_31g_oparen_3df_comma_3pd_cparen_(
  chemist::BasisSetManager& bsm) {
    chemist::BasisSetManager::ao_basis_map basis_map;

    // Z = 1
    basis_map.emplace(
      1, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 1, 0.0, 0.0, 0.0));
    ...
    // Z = 2
    basis_map.emplace(
      2, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 2, 0.0, 0.0, 0.0));
    ...
    // Z = 3
    basis_map.emplace(
      3, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 3, 0.0, 0.0, 0.0));
    ...
    // Z = 4
    basis_map.emplace(
      4, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 4, 0.0, 0.0, 0.0));
    ...
    // Z = 5
    basis_map.emplace(
      5, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 5, 0.0, 0.0, 0.0));
    ...
    // Z = 6
    basis_map.emplace(
      6, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 6, 0.0, 0.0, 0.0));
    ...
    // Z = 7
    basis_map.emplace(
      7, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 7, 0.0, 0.0, 0.0));
    ...
    // Z = 8
    basis_map.emplace(
      8, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 8, 0.0, 0.0, 0.0));
    ...
    // Z = 9
    basis_map.emplace(
      9, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 9, 0.0, 0.0, 0.0));
    ...
    // Z = 10
    basis_map.emplace(
      10, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 10, 0.0, 0.0, 0.0));
    ...
    // Z = 11
    basis_map.emplace(
      11, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 11, 0.0, 0.0, 0.0));
    ...
    // Z = 12
    basis_map.emplace(
      12, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 12, 0.0, 0.0, 0.0));
    ...
    // Z = 13
    basis_map.emplace(
      13, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 13, 0.0, 0.0, 0.0));
    ...
    // Z = 14
    basis_map.emplace(
      14, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 14, 0.0, 0.0, 0.0));
    ...
    // Z = 15
    basis_map.emplace(
      15, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 15, 0.0, 0.0, 0.0));
    ...
    // Z = 16
    basis_map.emplace(
      16, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 16, 0.0, 0.0, 0.0));
    ...
    // Z = 17
    basis_map.emplace(
      17, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 17, 0.0, 0.0, 0.0));
    ...
    // Z = 18
    basis_map.emplace(
      18, chemist::AtomicBasisSet<double>("6-31g(3df,3pd)", 18, 0.0, 0.0, 0.0));
