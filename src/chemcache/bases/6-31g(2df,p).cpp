...
void load_six_dash_31g_oparen_2df_comma_p_cparen_(
  chemist::BasisSetManager& bsm) {
    chemist::BasisSetManager::ao_basis_map basis_map;

    // Z = 1
    basis_map.emplace(
      1, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 1, 0.0, 0.0, 0.0));
    ...
    // Z = 2
    basis_map.emplace(
      2, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 2, 0.0, 0.0, 0.0));
    ...
    // Z = 3
    basis_map.emplace(
      3, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 3, 0.0, 0.0, 0.0));

    basis_map.at(3).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{2.1426000000e-03, 1.6208900000e-02, 7.7315600000e-02,
                          2.4578600000e-01, 4.7018900000e-01, 3.4547080000e-01},
      std::vector<double>{6.4241892000e+02, 9.6798515000e+01, 2.2091121000e+01,
                          6.2010703000e+00, 1.9351177000e+00,
                          6.3673580000e-01});
    basis_map.at(3).add_shell(
      chemist::ShellType::pure, 0,
    ...
    // Z = 4
    basis_map.emplace(
      4, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 4, 0.0, 0.0, 0.0));

    basis_map.at(4).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.9448000000e-03, 1.4835100000e-02, 7.2090600000e-02,
                          2.3715420000e-01, 4.6919870000e-01, 3.5652020000e-01},
      std::vector<double>{1.2645857000e+03, 1.8993681000e+02, 4.3159089000e+01,
                          1.2098663000e+01, 3.8063232000e+00,
                          1.2728903000e+00});
    basis_map.at(4).add_shell(
      chemist::ShellType::pure, 0,
    ...
    // Z = 5
    basis_map.emplace(
      5, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 5, 0.0, 0.0, 0.0));

    basis_map.at(5).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.8663000000e-03, 1.4251500000e-02, 6.9551600000e-02,
                          2.3257290000e-01, 4.6707870000e-01, 3.6343140000e-01},
      std::vector<double>{2.0688823000e+03, 3.1064957000e+02, 7.0683033000e+01,
                          1.9861080000e+01, 6.2993048000e+00,
                          2.1270270000e+00});
    basis_map.at(5).add_shell(
      chemist::ShellType::pure, 0,
    ...
    // Z = 6
    basis_map.emplace(
      6, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 6, 0.0, 0.0, 0.0));

    basis_map.at(6).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.8347000000e-03, 1.4037300000e-02, 6.8842600000e-02,
                          2.3218440000e-01, 4.6794130000e-01, 3.6231200000e-01},
      std::vector<double>{3.0475249000e+03, 4.5736951000e+02, 1.0394869000e+02,
                          2.9210155000e+01, 9.2866630000e+00,
                          3.1639270000e+00});
    basis_map.at(6).add_shell(
      chemist::ShellType::pure, 0,
    ...
    // Z = 7
    basis_map.emplace(
      7, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 7, 0.0, 0.0, 0.0));

    basis_map.at(7).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.8348000000e-03, 1.3995000000e-02, 6.8587000000e-02,
                          2.3224100000e-01, 4.6907000000e-01, 3.6045500000e-01},
      std::vector<double>{4.1735110000e+03, 6.2745790000e+02, 1.4290210000e+02,
                          4.0234330000e+01, 1.2820210000e+01,
                          4.3904370000e+00});
    basis_map.at(7).add_shell(
      chemist::ShellType::pure, 0,
    ...
    // Z = 8
    basis_map.emplace(
      8, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 8, 0.0, 0.0, 0.0));

    basis_map.at(8).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.8311000000e-03, 1.3950100000e-02, 6.8445100000e-02,
                          2.3271430000e-01, 4.7019300000e-01, 3.5852090000e-01},
      std::vector<double>{5.4846717000e+03, 8.2523495000e+02, 1.8804696000e+02,
                          5.2964500000e+01, 1.6897570000e+01,
                          5.7996353000e+00});
    basis_map.at(8).add_shell(
      chemist::ShellType::pure, 0,
    ...
    // Z = 9
    basis_map.emplace(
      9, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 9, 0.0, 0.0, 0.0));

    basis_map.at(9).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.8196169000e-03, 1.3916079600e-02, 6.8405324500e-02,
    ...
    // Z = 10
    basis_map.emplace(
      10, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 10, 0.0, 0.0, 0.0));

    basis_map.at(10).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.8843481000e-03, 1.4336899400e-02, 7.0109623300e-02,
    ...
    // Z = 11
    basis_map.emplace(
      11, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 11, 0.0, 0.0, 0.0));

    basis_map.at(11).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.9377000000e-03, 1.4807000000e-02, 7.2706000000e-02,
                          2.5262900000e-01, 4.9324200000e-01, 3.1316900000e-01},
      std::vector<double>{9.9932000000e+03, 1.4998900000e+03, 3.4195100000e+02,
                          9.4679700000e+01, 2.9734500000e+01,
                          1.0006300000e+01});
    basis_map.at(11).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{-3.5421000000e-03, -4.3959000000e-02,
                          -1.0975210000e-01, 1.8739800000e-01, 6.4669900000e-01,
                          3.0605800000e-01},
    ...
    basis_map.at(11).add_shell(
      chemist::ShellType::pure, 1,
      std::vector<double>{5.0017000000e-03, 3.5511000000e-02, 1.4282500000e-01,
    ...
    // Z = 12
    basis_map.emplace(
      12, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 12, 0.0, 0.0, 0.0));

    basis_map.at(12).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.9778000000e-03, 1.5114000000e-02, 7.3911000000e-02,
    ...
    basis_map.at(12).add_shell(
      ...
      std::vector<double>{-3.2372000000e-03, -4.1008000000e-02,
                          -1.1260000000e-01, 1.4863300000e-01, 6.1649700000e-01,
                          3.6482900000e-01},
    ...
    basis_map.at(12).add_shell(
      chemist::ShellType::pure, 1,
      std::vector<double>{4.9281000000e-03, 3.4989000000e-02, 1.4072500000e-01,
    ...
    // Z = 13
    basis_map.emplace(
      13, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 13, 0.0, 0.0, 0.0));

    basis_map.at(13).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.9426700000e-03, 1.4859900000e-02, 7.2849400000e-02,
    ...
    basis_map.at(13).add_shell(
      ...
      std::vector<double>{-2.9261900000e-03, -3.7408000000e-02,
                          -1.1448700000e-01, 1.1563500000e-01, 6.1259500000e-01,
                          3.9379900000e-01},
    ...
    basis_map.at(13).add_shell(
      chemist::ShellType::pure, 1,
      std::vector<double>{4.6028500000e-03, 3.3199000000e-02, 1.3628200000e-01,
    ...
    // Z = 14
    basis_map.emplace(
      14, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 14, 0.0, 0.0, 0.0));

    basis_map.at(14).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.9594800000e-03, 1.4928800000e-02, 7.2847800000e-02,
    ...
    basis_map.at(14).add_shell(
      ...
      std::vector<double>{-2.7809400000e-03, -3.5714600000e-02,
                          -1.1498500000e-01, 9.3563400000e-02, 6.0301700000e-01,
                          4.1895900000e-01},
    ...
    basis_map.at(14).add_shell(
      chemist::ShellType::pure, 1,
      std::vector<double>{4.4382600000e-03, 3.2667900000e-02, 1.3472100000e-01,
    ...
    // Z = 15
    basis_map.emplace(
      15, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 15, 0.0, 0.0, 0.0));

    basis_map.at(15).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.8516000000e-03, 1.4206200000e-02, 6.9999500000e-02,
    ...
    basis_map.at(15).add_shell(
      ...
      std::vector<double>{-2.7821700000e-03, -3.6049900000e-02,
                          -1.1663100000e-01, 9.6832800000e-02, 6.1441800000e-01,
                          4.0379800000e-01},
    ...
    basis_map.at(15).add_shell(
      chemist::ShellType::pure, 1,
      std::vector<double>{4.5646200000e-03, 3.3693600000e-02, 1.3975500000e-01,
    ...
    // Z = 16
    basis_map.emplace(
      16, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 16, 0.0, 0.0, 0.0));

    basis_map.at(16).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.8690000000e-03, 1.4230000000e-02, 6.9696000000e-02,
    ...
    basis_map.at(16).add_shell(
      ...
      std::vector<double>{-2.3767000000e-03, -3.1693000000e-02,
                          -1.1331700000e-01, 5.6090000000e-02, 5.9225500000e-01,
                          4.5500600000e-01},
    ...
    basis_map.at(16).add_shell(
      chemist::ShellType::pure, 1,
      std::vector<double>{4.0610000000e-03, 3.0681000000e-02, 1.3045200000e-01,
    ...
    // Z = 17
    basis_map.emplace(
      17, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 17, 0.0, 0.0, 0.0));

    basis_map.at(17).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.8330000000e-03, 1.4034000000e-02, 6.9097000000e-02,
    ...
    basis_map.at(17).add_shell(
      ...
      std::vector<double>{-2.2974000000e-03, -3.0714000000e-02,
                          -1.1252800000e-01, 4.5016000000e-02, 5.8935300000e-01,
                          4.6520600000e-01},
    ...
    basis_map.at(17).add_shell(
      chemist::ShellType::pure, 1,
      std::vector<double>{3.9894000000e-03, 3.0318000000e-02, 1.2988000000e-01,
    ...
    // Z = 18
    basis_map.emplace(
      18, chemist::AtomicBasisSet<double>("6-31g(2df,p)", 18, 0.0, 0.0, 0.0));

    basis_map.at(18).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{1.8252600000e-03, 1.3968600000e-02, 6.8707300000e-02,
    ...
    basis_map.at(18).add_shell(
      ...
      std::vector<double>{-2.1597200000e-03, -2.9077500000e-02,
                          -1.1082700000e-01, 2.7699900000e-02, 5.7761300000e-01,
                          4.8868800000e-01},
    ...
    basis_map.at(18).add_shell(
      chemist::ShellType::pure, 1,
      std::vector<double>{3.8066500000e-03, 2.9230500000e-02, 1.2646700000e-01,
    ...
    bsm.insert("6-31g(2df,p)", basis_map);
} // function load_six_dash_31g_oparen_2df_comma_p_cparen_
