...
MODULE_RUN(aug_dash_cc_dash_pwcvdz_dash_pp_dash_optri_atom_basis) {
    ...
    switch(Z) {
        case(29): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz-pp-optri", 29, 0.0, 0.0, 0.0);
        ...
        case(30): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz-pp-optri", 30, 0.0, 0.0, 0.0);
            atom_bs.add_shell(chemist::ShellType::pure, 0,
                              std::vector<double>{1.0000000000e+00},
        ...
        case(47): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz-pp-optri", 47, 0.0, 0.0, 0.0);
            atom_bs.add_shell(chemist::ShellType::pure, 0,
                              std::vector<double>{1.0000000000e+00},
        ...
        case(48): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz-pp-optri", 48, 0.0, 0.0, 0.0);
            atom_bs.add_shell(chemist::ShellType::pure, 0,
                              std::vector<double>{1.0000000000e+00},
        ...
        case(79): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz-pp-optri", 79, 0.0, 0.0, 0.0);
            atom_bs.add_shell(chemist::ShellType::pure, 0,
                              std::vector<double>{1.0000000000e+00},
        ...
        case(80): {
            atomic_basis_t atom_bs("aug-cc-pwcvdz-pp-optri", 80, 0.0, 0.0, 0.0);
            atom_bs.add_shell(chemist::ShellType::pure, 0,
                              std::vector<double>{1.0000000000e+00},
