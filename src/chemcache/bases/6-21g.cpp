...
MODULE_RUN(six_dash_21g_atom_basis) {
    ...
    switch(Z) {
        ...
        case(3): {
            ...
            shells.emplace_back(make_shell(
              pure_t::pure, 0,
              doubles_t{2.1509588790e-03, 1.6267691520e-02, 7.7638259540e-02,
                        2.4649487150e-01, 4.6750575630e-01, 3.4691481920e-01},
              doubles_t{6.4241800000e+02, 9.6516400000e+01, 2.2017400000e+01,
                        6.1764500000e+00, 1.9351100000e+00, 6.3957700000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-2.6312640580e-01, 1.1433874180e+00},
              doubles_t{5.4020500000e-01, 1.0225500000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{1.6154597080e-01, 9.1566283470e-01},
              doubles_t{5.4020500000e-01, 1.0225500000e-01}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(4): {
            ...
            shells.emplace_back(make_shell(
              pure_t::pure, 0,
              doubles_t{1.9433606270e-03, 1.4825104780e-02, 7.2066223250e-02,
                        2.3702207650e-01, 4.6878915120e-01, 3.5638211500e-01},
              doubles_t{1.2645000000e+03, 1.8993000000e+02, 4.3127500000e+01,
                        1.2088900000e+01, 3.8079000000e+00, 1.2826600000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-4.2106406590e-01, 1.2240701920e+00},
              doubles_t{1.2954800000e+00, 2.6888100000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{2.0513192370e-01, 8.8252767190e-01},
              doubles_t{1.2954800000e+00, 2.6888100000e-01}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(5): {
            ...
            shells.emplace_back(make_shell(
              pure_t::pure, 0,
              doubles_t{1.8498587790e-03, 1.4127690670e-02, 6.9269654270e-02,
                        2.3239284660e-01, 4.7015368960e-01, 3.6028776210e-01},
              doubles_t{2.0821200000e+03, 3.1231000000e+02, 7.0887400000e+01,
                        1.9852500000e+01, 6.2916100000e+00, 2.1286200000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-3.6866347730e-01, 1.1994448060e+00},
              doubles_t{2.2818700000e+00, 4.6524800000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{2.3115190230e-01, 8.6676363370e-01},
              doubles_t{2.2818700000e+00, 4.6524800000e-01}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(6): {
            ...
            shells.emplace_back(make_shell(
              pure_t::pure, 0,
              doubles_t{1.8258801230e-03, 1.4056600940e-02, 6.8757004620e-02,
                        2.3042201550e-01, 4.6846303150e-01, 3.6278002440e-01},
              doubles_t{3.0475200000e+03, 4.5642400000e+02, 1.0365300000e+02,
                        2.9225800000e+01, 9.3486300000e+00, 3.1890400000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-3.9589516210e-01, 1.2158343560e+00},
              doubles_t{3.6649800000e+00, 7.7054500000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{2.3645994660e-01, 8.6061880570e-01},
              doubles_t{3.6649800000e+00, 7.7054500000e-01}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(7): {
            ...
            shells.emplace_back(make_shell(
              pure_t::pure, 0,
              doubles_t{1.8454099110e-03, 1.4164499320e-02, 6.8632496710e-02,
                        2.2857398900e-01, 4.6616197760e-01, 3.6567198250e-01},
              doubles_t{4.1501100000e+03, 6.2008400000e+02, 1.4168800000e+02,
                        4.0336700000e+01, 1.3026700000e+01, 4.4700300000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-4.1330007740e-01, 1.2244172670e+00},
              doubles_t{5.4252200000e+00, 1.1491500000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{2.3797201620e-01, 8.5895305860e-01},
              doubles_t{5.4252200000e+00, 1.1491500000e+00}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(8): {
            ...
            shells.emplace_back(make_shell(
              pure_t::pure, 0,
              doubles_t{1.8321688100e-03, 1.4104690840e-02, 6.8626155420e-02,
                        2.2937585100e-01, 4.6639869700e-01, 3.6417276340e-01},
              doubles_t{5.4722700000e+03, 8.1780600000e+02, 1.8644600000e+02,
                        5.3023000000e+01, 1.7180000000e+01, 5.9119600000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-4.0445358320e-01, 1.2215617610e+00},
              doubles_t{7.4029400000e+00, 1.5762000000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{2.4458610700e-01, 8.5395537350e-01},
              doubles_t{7.4029400000e+00, 1.5762000000e+00}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(9): {
            ...
            shells.emplace_back(make_shell(
              pure_t::pure, 0,
              doubles_t{1.8846298750e-03, 1.3812099090e-02, 6.6249295620e-02,
                        2.2187498530e-01, 4.6084196950e-01, 3.7845297500e-01},
              doubles_t{6.7831900000e+03, 1.0424400000e+03, 2.4239800000e+02,
                        6.9632000000e+01, 2.2689400000e+01, 7.7963600000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-4.0732627770e-01, 1.2231378310e+00},
              doubles_t{9.7775900000e+00, 2.0861700000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{2.4668000320e-01, 8.5232101100e-01},
              doubles_t{9.7775900000e+00, 2.0861700000e+00}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(10): {
            ...
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-4.0992232080e-01, 1.2243109580e+00},
              doubles_t{1.2483000000e+01, 2.6645100000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{2.4745998360e-01, 8.5174294350e-01},
              doubles_t{1.2483000000e+01, 2.6645100000e+00}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(11): {
            ...
            shells.emplace_back(make_shell(
              ...
              doubles_t{1.5096300000e+02, 3.5587800000e+01, 1.1168300000e+01,
                        3.9020100000e+00, 1.3817700000e+00, 4.6638200000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-2.1966049750e-01, 1.0891224670e+00},
              doubles_t{5.0182400000e-01, 6.0945800000e-02}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{9.0664879580e-03, 9.9720177540e-01},
              doubles_t{5.0182400000e-01, 6.0945800000e-02}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(12): {
            ...
            shells.emplace_back(make_shell(
              ...
              doubles_t{1.8918000000e+02, 4.5211900000e+01, 1.4356300000e+01,
                        5.1388600000e+00, 1.9065200000e+00, 7.0588700000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-3.6110259330e-01, 1.2150553610e+00},
              doubles_t{6.1134900000e-01, 1.4184100000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{2.4263309200e-02, 9.8667337390e-01},
              doubles_t{6.1134900000e-01, 1.4184100000e-01}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(13): {
            ...
            shells.emplace_back(make_shell(
              ...
              doubles_t{2.3966800000e+02, 5.7441900000e+01, 1.8285900000e+01,
                        6.5991400000e+00, 2.4904900000e+00, 9.4454500000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-3.2032690910e-01, 1.1841196640e+00},
              doubles_t{9.4616000000e-01, 2.0250600000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{5.1938280870e-02, 9.7265964170e-01},
              doubles_t{9.4616000000e-01, 2.0250600000e-01}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(14): {
            ...
            shells.emplace_back(make_shell(
              ...
              doubles_t{2.9271800000e+02, 6.9873100000e+01, 2.2336300000e+01,
                        8.1503900000e+00, 3.1345800000e+00, 1.2254300000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-3.7610787950e-01, 1.2516495990e+00},
              doubles_t{1.0791300000e+00, 3.0242200000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{6.7102991120e-02, 9.5688287340e-01},
              doubles_t{1.0791300000e+00, 3.0242200000e-01}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(15): {
            ...
            shells.emplace_back(make_shell(
              ...
              doubles_t{3.3947800000e+02, 8.1010100000e+01, 2.5878000000e+01,
                        9.4522100000e+00, 3.6656600000e+00, 1.4674600000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-3.7149602190e-01, 1.2709934960e+00},
              doubles_t{1.2186500000e+00, 3.9554600000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{9.1582310220e-02, 9.3492410430e-01},
              doubles_t{1.2186500000e+00, 3.9554600000e-01}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(16): {
            ...
            shells.emplace_back(make_shell(
              ...
              doubles_t{4.2373500000e+02, 1.0071000000e+02, 3.2159900000e+01,
                        1.1807900000e+01, 4.6311000000e+00, 1.8702500000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-2.8608885370e-01, 1.2280593720e+00},
              doubles_t{1.2238400000e+00, 4.5730300000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{1.6477699470e-01, 8.7085497220e-01},
              doubles_t{1.2238400000e+00, 4.5730300000e-01}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(17): {
            ...
            shells.emplace_back(make_shell(
              ...
              doubles_t{4.9176500000e+02, 1.1698400000e+02, 3.7415300000e+01,
                        1.3783400000e+01, 5.4521500000e+00, 2.2258800000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-2.2240148410e-01, 1.1825225740e+00},
              doubles_t{1.3529900000e+00, 5.2695500000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{2.1921579720e-01, 8.2232023930e-01},
              doubles_t{1.3529900000e+00, 5.2695500000e-01}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
        ...
        case(18): {
            ...
            shells.emplace_back(make_shell(
              ...
              doubles_t{5.7589100000e+02, 1.3681600000e+02, 4.3809800000e+01,
                        1.6209400000e+01, 6.4608400000e+00, 2.6511400000e+00}));
            shells.emplace_back(make_shell(
              pure_t::pure, 0, doubles_t{-1.7686556850e-01, 1.1468972020e+00},
              doubles_t{1.5420900000e+00, 6.0726700000e-01}));
            shells.emplace_back(make_shell(
              pure_t::pure, 1, doubles_t{2.5568701300e-01, 7.8984204010e-01},
              doubles_t{1.5420900000e+00, 6.0726700000e-01}));
            shells.emplace_back(make_shell(pure_t::pure, 0,
                                           doubles_t{1.0000000000e+00},
