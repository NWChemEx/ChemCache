...
void load_cc_dash_pwcvdz(chemist::BasisSetManager& bsm) {
    ...
    // Z = 5
    basis_map.emplace(
      5, chemist::AtomicBasisSet<double>("cc-pwcvdz", 5, 0.0, 0.0, 0.0));
    ...
    // Z = 6
    basis_map.emplace(
      6, chemist::AtomicBasisSet<double>("cc-pwcvdz", 6, 0.0, 0.0, 0.0));
    ...
    // Z = 7
    basis_map.emplace(
      7, chemist::AtomicBasisSet<double>("cc-pwcvdz", 7, 0.0, 0.0, 0.0));
    ...
    // Z = 8
    basis_map.emplace(
      8, chemist::AtomicBasisSet<double>("cc-pwcvdz", 8, 0.0, 0.0, 0.0));
    ...
    // Z = 9
    basis_map.emplace(
      9, chemist::AtomicBasisSet<double>("cc-pwcvdz", 9, 0.0, 0.0, 0.0));
    ...
    // Z = 10
    basis_map.emplace(
      10, chemist::AtomicBasisSet<double>("cc-pwcvdz", 10, 0.0, 0.0, 0.0));
    ...
    // Z = 13
    basis_map.emplace(
      13, chemist::AtomicBasisSet<double>("cc-pwcvdz", 13, 0.0, 0.0, 0.0));
    ...
    // Z = 14
    basis_map.emplace(
      14, chemist::AtomicBasisSet<double>("cc-pwcvdz", 14, 0.0, 0.0, 0.0));
    ...
    // Z = 15
    basis_map.emplace(
      15, chemist::AtomicBasisSet<double>("cc-pwcvdz", 15, 0.0, 0.0, 0.0));
    ...
    // Z = 16
    basis_map.emplace(
      16, chemist::AtomicBasisSet<double>("cc-pwcvdz", 16, 0.0, 0.0, 0.0));
    ...
    // Z = 17
    basis_map.emplace(
      17, chemist::AtomicBasisSet<double>("cc-pwcvdz", 17, 0.0, 0.0, 0.0));
    ...
    // Z = 18
    basis_map.emplace(
      18, chemist::AtomicBasisSet<double>("cc-pwcvdz", 18, 0.0, 0.0, 0.0));
    ...
    bsm.insert("cc-pwcvdz", basis_map);
} // function load_cc_dash_pwcvdz
