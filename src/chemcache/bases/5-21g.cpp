...
void load_5_dash_21g(chemist::BasisSetManager& bsm) {
    ...
    // Z = 1
    basis_map.emplace(
      1, chemist::AtomicBasisSet<double>("5-21g", 1, 0.0, 0.0, 0.0));
    ...
    // Z = 2
    basis_map.emplace(
      2, chemist::AtomicBasisSet<double>("5-21g", 2, 0.0, 0.0, 0.0));
    ...
    // Z = 3
    basis_map.emplace(
      3, chemist::AtomicBasisSet<double>("5-21g", 3, 0.0, 0.0, 0.0));

    basis_map.at(3).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{6.1218469100e-03, 4.5112961500e-02, 1.9269415000e-01,
                          4.6854420800e-01, 4.4060751500e-01},
      std::vector<double>{2.7539444400e+02, 4.1435175400e+01, 9.3669937800e+00,
    ...
    // Z = 4
    basis_map.emplace(
      4, chemist::AtomicBasisSet<double>("5-21g", 4, 0.0, 0.0, 0.0));

    basis_map.at(4).add_shell(
      chemist::ShellType::pure, 0,
      std::vector<double>{5.4099743720e-03, 4.0251532530e-02, 1.7685814290e-01,
                          4.5255936570e-01, 4.7029338000e-01},
      std::vector<double>{5.5401000000e+02, 8.3263100000e+01, 1.8863500000e+01,
