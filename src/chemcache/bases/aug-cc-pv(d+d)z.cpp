...
aug-cc-pv(d+d)z atomic basis set
---------------------------------
...
MODULE_CTOR(aug_dash_cc_dash_pv_oparen_d_plus_d_cparen_z_atom_basis) {
    description(module_desc);
    satisfies_property_type<atomic_basis_pt>();
}

MODULE_RUN(aug_dash_cc_dash_pv_oparen_d_plus_d_cparen_z_atom_basis) {
    const auto& [Z] = atomic_basis_pt::unwrap_inputs(inputs);
    auto rv         = results();

    switch(Z) {
        case(1): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 1, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{1.9685000000e-02, 1.3797700000e-01,
                                  4.7814800000e-01, 5.0124000000e-01},
              std::vector<double>{1.3010000000e+01, 1.9620000000e+00,
                                  4.4460000000e-01, 1.2200000000e-01});
        ...
        case(2): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 2, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{2.3809000000e-02, 1.5489100000e-01,
                                  4.6998700000e-01, 5.1302700000e-01},
              std::vector<double>{3.8360000000e+01, 5.7700000000e+00,
                                  1.2400000000e+00, 2.9760000000e-01});
            atom_bs.add_shell(chemist::ShellType::pure, 0,
                              std::vector<double>{1.0000000000e+00},
        ...
        case(3): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 3, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                7.6600000000e-04, 5.8920000000e-03, 2.9671000000e-02,
                1.0918000000e-01, 2.8278900000e-01, 4.5312300000e-01,
                2.7477400000e-01, 9.7510000000e-03, -3.1800000000e-03},
              std::vector<double>{
                1.4690000000e+03, 2.2050000000e+02, 5.0260000000e+01,
            ...
            atom_bs.add_shell(
              ...
              std::vector<double>{2.2784000000e-02, 1.3910700000e-01,
                                  5.0037500000e-01, 5.0847400000e-01},
              std::vector<double>{1.5340000000e+00, 2.7490000000e-01,
        ...
        case(4): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 4, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                6.8000000000e-04, 5.2360000000e-03, 2.6606000000e-02,
                9.9993000000e-02, 2.6970200000e-01, 4.5146900000e-01,
                2.9507400000e-01, 1.2587000000e-02, -3.7560000000e-03},
              std::vector<double>{
                2.9400000000e+03, 4.4120000000e+02, 1.0050000000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{2.9111000000e-02, 1.6936500000e-01,
                                  5.1345800000e-01, 4.7933800000e-01},
              std::vector<double>{3.6190000000e+00, 7.1100000000e-01,
        ...
        case(5): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 5, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                6.9600000000e-04, 5.3530000000e-03, 2.7134000000e-02,
                1.0138000000e-01, 2.7205500000e-01, 4.4840300000e-01,
                2.9012300000e-01, 1.4322000000e-02, -3.4860000000e-03},
              std::vector<double>{
                4.5700000000e+03, 6.8590000000e+02, 1.5650000000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{3.5481000000e-02, 1.9807200000e-01,
                                  5.0523000000e-01, 4.7949900000e-01},
              std::vector<double>{6.0010000000e+00, 1.2410000000e+00,
        ...
        case(6): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 6, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                6.9200000000e-04, 5.3290000000e-03, 2.7077000000e-02,
                1.0171800000e-01, 2.7474000000e-01, 4.4856400000e-01,
                2.8507400000e-01, 1.5204000000e-02, -3.1910000000e-03},
              std::vector<double>{
                6.6650000000e+03, 1.0000000000e+03, 2.2800000000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{3.8109000000e-02, 2.0948000000e-01,
                                  5.0855700000e-01, 4.6884200000e-01},
              std::vector<double>{9.4390000000e+00, 2.0020000000e+00,
        ...
        case(7): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 7, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                7.0000000000e-04, 5.3890000000e-03, 2.7406000000e-02,
                1.0320700000e-01, 2.7872300000e-01, 4.4854000000e-01,
                2.7823800000e-01, 1.5440000000e-02, -2.8640000000e-03},
              std::vector<double>{
                9.0460000000e+03, 1.3570000000e+03, 3.0930000000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{3.9919000000e-02, 2.1716900000e-01,
                                  5.1031900000e-01, 4.6221400000e-01},
              std::vector<double>{1.3550000000e+01, 2.9170000000e+00,
        ...
        case(8): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 8, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                7.1000000000e-04, 5.4700000000e-03, 2.7837000000e-02,
                1.0480000000e-01, 2.8306200000e-01, 4.4871900000e-01,
                2.7095200000e-01, 1.5458000000e-02, -2.5850000000e-03},
              std::vector<double>{
                1.1720000000e+04, 1.7590000000e+03, 4.0080000000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{4.3018000000e-02, 2.2891300000e-01,
                                  5.0872800000e-01, 4.6053100000e-01},
              std::vector<double>{1.7700000000e+01, 3.8540000000e+00,
        ...
        case(9): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 9, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                7.2100000000e-04, 5.5530000000e-03, 2.8267000000e-02,
                1.0644400000e-01, 2.8681400000e-01, 4.4864100000e-01,
                2.6476100000e-01, 1.5333000000e-02, -2.3320000000e-03},
              std::vector<double>{
                1.4710000000e+04, 2.2070000000e+03, 5.0280000000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{4.4878000000e-02, 2.3571800000e-01,
                                  5.0852100000e-01, 4.5812000000e-01},
              std::vector<double>{2.2670000000e+01, 4.9770000000e+00,
        ...
        case(10): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 10, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                7.3800000000e-04, 5.6770000000e-03, 2.8883000000e-02,
                1.0854000000e-01, 2.9090700000e-01, 4.4832400000e-01,
                2.5802600000e-01, 1.5063000000e-02, -2.1000000000e-03},
              std::vector<double>{
                1.7880000000e+04, 2.6830000000e+03, 6.1150000000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{4.6087000000e-02, 2.4018100000e-01,
                                  5.0874400000e-01, 4.5566000000e-01},
              std::vector<double>{2.8390000000e+01, 6.2700000000e+00,
        ...
        case(11): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 11, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                4.5887800000e-04, 3.5507000000e-03, 1.8261800000e-02,
              ...
              std::vector<double>{
                3.1700000000e+04, 4.7550000000e+03, 1.0820000000e+03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                1.7016000000e-05, 1.3069300000e-04, 6.8778400000e-04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{5.7964100000e-03, 4.1575600000e-02,
                                  1.6287300000e-01, 3.5940100000e-01,
                                  4.4998800000e-01, 2.2750700000e-01,
                                  8.0824700000e-03, -1.9629300000e-03},
              std::vector<double>{1.3810000000e+02, 3.2240000000e+01,
                                  9.9850000000e+00, 3.4840000000e+00,
                                  1.2310000000e+00, 4.1770000000e-01,
        ...
        case(12): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 12, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                3.4602300000e-04, 2.6807700000e-03, 1.3836700000e-02,
              ...
              std::vector<double>{
                4.7390000000e+04, 7.1080000000e+03, 1.6180000000e+03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                1.6962800000e-05, 1.2986500000e-04, 6.8883100000e-04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{5.3816100000e-03, 3.9241800000e-02,
                                  1.5744500000e-01, 3.5853500000e-01,
                                  4.5722600000e-01, 2.1591800000e-01,
                                  6.6494800000e-03, -1.2530400000e-04},
              std::vector<double>{1.7990000000e+02, 4.2140000000e+01,
                                  1.3130000000e+01, 4.6280000000e+00,
                                  1.6700000000e+00, 5.8570000000e-01,
        ...
        case(13): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 13, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.9025000000e-04, 2.2506400000e-03, 1.1645900000e-02,
              ...
              std::vector<double>{
                6.4150000000e+04, 9.6170000000e+03, 2.1890000000e+03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                1.7507800000e-05, 1.3420800000e-04, 7.1244200000e-04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{4.0684700000e-03, 3.0681500000e-02,
                                  1.2914900000e-01, 3.2083100000e-01,
                                  4.5381500000e-01, 2.7506600000e-01,
                                  1.9080700000e-02, -3.1284800000e-03},
              std::vector<double>{2.5880000000e+02, 6.0890000000e+01,
                                  1.9140000000e+01, 6.8810000000e+00,
                                  2.5740000000e+00, 9.5720000000e-01,
        ...
        case(14): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 14, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.7044300000e-04, 2.0971700000e-03, 1.0850600000e-02,
              ...
              std::vector<double>{
                7.8860000000e+04, 1.1820000000e+04, 2.6920000000e+03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                1.8511300000e-05, 1.4223600000e-04, 7.5218500000e-04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{3.9265600000e-03, 2.9881100000e-02,
                                  1.2721200000e-01, 3.2094300000e-01,
                                  4.5542900000e-01, 2.6856300000e-01,
                                  1.8833600000e-02, -2.6243100000e-03},
              std::vector<double>{3.1590000000e+02, 7.4420000000e+01,
                                  2.3480000000e+01, 8.4880000000e+00,
                                  3.2170000000e+00, 1.2290000000e+00,
        ...
        case(15): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 15, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.5550900000e-04, 1.9819300000e-03, 1.0276000000e-02,
              ...
              std::vector<double>{
                9.4840000000e+04, 1.4220000000e+04, 3.2360000000e+03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                1.9119900000e-05, 1.4722300000e-04, 7.7791200000e-04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{3.9500500000e-03, 3.0249200000e-02,
                                  1.2955400000e-01, 3.2759400000e-01,
                                  4.5699200000e-01, 2.5308600000e-01,
                                  1.6879800000e-02, -2.0709300000e-03},
              std::vector<double>{3.7050000000e+02, 8.7330000000e+01,
                                  2.7590000000e+01, 1.0000000000e+01,
                                  3.8250000000e+00, 1.4940000000e+00,
        ...
        case(16): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 16, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.4763500000e-04, 1.9202600000e-03, 9.9619200000e-03,
              ...
              std::vector<double>{
                1.1080000000e+05, 1.6610000000e+04, 3.7810000000e+03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                1.9907700000e-05, 1.5348300000e-04, 8.0950300000e-04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{4.4754100000e-03, 3.4170800000e-02,
                                  1.4425000000e-01, 3.5392800000e-01,
                                  4.5908500000e-01, 2.0638300000e-01,
                                  1.0214100000e-02, -6.0312200000e-05},
              std::vector<double>{3.9970000000e+02, 9.4190000000e+01,
                                  2.9750000000e+01, 1.0770000000e+01,
                                  4.1190000000e+00, 1.6250000000e+00,
                                  4.7260000000e-01, 1.4070000000e-01});
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{-1.1625100000e-03, -8.6566400000e-03,
                                  -3.9088600000e-02, -9.3462500000e-02,
                                  -1.4799400000e-01, 3.0190400000e-02,
        ...
        case(17): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 17, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.4115300000e-04, 1.8709500000e-03, 9.7082700000e-03,
              ...
              std::vector<double>{
                1.2790000000e+05, 1.9170000000e+04, 4.3630000000e+03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.0498600000e-05, 1.5829800000e-04, 8.3363900000e-04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{5.2598200000e-03, 3.9833200000e-02,
                                  1.6465500000e-01, 3.8732200000e-01,
                                  4.5707200000e-01, 1.5163600000e-01,
                                  1.8161500000e-03, 1.8829600000e-03},
              std::vector<double>{4.1760000000e+02, 9.8330000000e+01,
                                  3.1040000000e+01, 1.1190000000e+01,
                                  4.2490000000e+00, 1.6240000000e+00,
                                  5.3220000000e-01, 1.6200000000e-01});
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{-1.4357000000e-03, -1.0779600000e-02,
                                  -4.7007500000e-02, -1.1103000000e-01,
                                  -1.5327500000e-01, 8.9460900000e-02,
        ...
        case(18): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 18, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.3670000000e-04, 1.8352300000e-03, 9.5286000000e-03,
              ...
              std::vector<double>{
                1.4570000000e+05, 2.1840000000e+04, 4.9720000000e+03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.1045700000e-05, 1.6256500000e-04, 8.5546300000e-04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{5.7055500000e-03, 4.3046000000e-02,
                                  1.7659100000e-01, 4.0686300000e-01,
                                  4.5254900000e-01, 1.2280100000e-01,
                                  -4.4599600000e-03, 2.0522500000e-03},
              std::vector<double>{4.5370000000e+02, 1.0680000000e+02,
                                  3.3730000000e+01, 1.2130000000e+01,
                                  4.5940000000e+00, 1.6780000000e+00,
                                  5.9090000000e-01, 1.8520000000e-01});
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{-1.6065500000e-03, -1.2171400000e-02,
                                  -5.2078900000e-02, -1.2373700000e-01,
                                  -1.5161900000e-01, 1.4242500000e-01,
        ...
        case(21): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 21, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(22): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 22, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(23): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 23, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(24): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 24, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(25): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 25, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(26): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 26, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(27): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 27, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(28): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 28, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(29): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 29, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(30): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 30, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
        ...
        case(31): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 31, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.0680000000e-04, 1.6047000000e-03, 8.3402000000e-03,
              ...
              std::vector<double>{
                4.8513000000e+05, 7.2719000000e+04, 1.6552000000e+04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.4500000000e-05, 1.8950000000e-04, 9.9640000000e-04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                1.5260000000e-03, 1.2748600000e-02, 6.3374200000e-02,
              ...
              std::vector<double>{
                3.2486000000e+03, 7.6997000000e+02, 2.4820000000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                -5.8030000000e-04, -4.8647000000e-03, -2.4839400000e-02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                9.5000000000e-05, 7.8320000000e-04, 4.0855000000e-03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 2,
              std::vector<double>{2.7382500000e-02, 1.5108050000e-01,
                                  3.7492170000e-01, 4.7507990000e-01,
                                  2.9827500000e-01},
              std::vector<double>{6.5337000000e+01, 1.8497000000e+01,
                                  6.3150000000e+00, 2.1635000000e+00,
                                  6.6675000000e-01});
            atom_bs.add_shell(chemist::ShellType::pure, 2,
                              std::vector<double>{1.0000000000e+00},
        ...
        case(32): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 32, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.0450000000e-04, 1.5868000000e-03, 8.2480000000e-03,
              ...
              std::vector<double>{
                5.2180000000e+05, 7.8214000000e+04, 1.7803000000e+04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.4600000000e-05, 1.9000000000e-04, 9.9930000000e-04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                1.4591000000e-03, 1.2217600000e-02, 6.1049000000e-02,
              ...
              std::vector<double>{
                3.5681000000e+03, 8.4572000000e+02, 2.7274000000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                -5.6300000000e-04, -4.7354000000e-03, -2.4264300000e-02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                1.1150000000e-04, 9.2120000000e-04, 4.8273000000e-03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 2,
              std::vector<double>{2.5768400000e-02, 1.4544210000e-01,
                                  3.7137210000e-01, 4.8000020000e-01,
                                  2.8968000000e-01},
              std::vector<double>{7.4762000000e+01, 2.1302000000e+01,
                                  7.3436000000e+00, 2.5651000000e+00,
                                  8.1970000000e-01});
            atom_bs.add_shell(chemist::ShellType::pure, 2,
                              std::vector<double>{1.0000000000e+00},
        ...
        case(33): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 33, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.0240000000e-04, 1.5709000000e-03, 8.1662000000e-03,
              ...
              std::vector<double>{
                5.5958380000e+05, 8.3879330000e+04, 1.9092670000e+04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.4600000000e-05, 1.9070000000e-04, 1.0031000000e-03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                1.4097000000e-03, 1.1827700000e-02, 5.9328000000e-02,
              ...
              std::vector<double>{
                3.8863560000e+03, 9.2120200000e+02, 2.9719320000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                -5.5190000000e-04, -4.6550000000e-03, -2.3917600000e-02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                1.2360000000e-04, 1.0240000000e-03, 5.3805000000e-03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 2,
              std::vector<double>{2.4528800000e-02, 1.4113400000e-01,
                                  3.6875790000e-01, 4.8406260000e-01,
                                  2.8244340000e-01},
              std::vector<double>{8.4424230000e+01, 2.4181590000e+01,
                                  8.4017770000e+00, 2.9805020000e+00,
                                  9.7900300000e-01});
            atom_bs.add_shell(chemist::ShellType::pure, 2,
                              std::vector<double>{1.0000000000e+00},
        ...
        case(34): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 34, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.0040000000e-04, 1.5554000000e-03, 8.0872000000e-03,
              ...
              std::vector<double>{
                5.9899000000e+05, 8.9783000000e+04, 2.0435000000e+04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.4700000000e-05, 1.9130000000e-04, 1.0068000000e-03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                1.4127000000e-03, 1.1858800000e-02, 5.9515300000e-02,
              ...
              std::vector<double>{
                4.1356000000e+03, 9.8034000000e+02, 3.1635000000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                -5.6100000000e-04, -4.7340000000e-03, -2.4350400000e-02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                1.3660000000e-04, 1.1308000000e-03, 5.9581000000e-03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 2,
              std::vector<double>{2.3498200000e-02, 1.3751830000e-01,
                                  3.6648240000e-01, 4.8747170000e-01,
                                  2.7657690000e-01},
              std::vector<double>{9.4472000000e+01, 2.7180000000e+01,
                                  9.5068000000e+00, 3.4168000000e+00,
                                  1.1479000000e+00});
            atom_bs.add_shell(chemist::ShellType::pure, 2,
                              std::vector<double>{1.0000000000e+00},
        ...
        case(35): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 35, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                1.9840000000e-04, 1.5400000000e-03, 8.0096000000e-03,
              ...
              std::vector<double>{
                6.4010000000e+05, 9.5938000000e+04, 2.1833000000e+04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.4800000000e-05, 1.9190000000e-04, 1.0100000000e-03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                1.4448000000e-03, 1.2128800000e-02, 6.0807700000e-02,
              ...
              std::vector<double>{
                4.3408000000e+03, 1.0289000000e+03, 3.3202000000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                -5.8190000000e-04, -4.9065000000e-03, -2.5251400000e-02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                1.5180000000e-04, 1.2563000000e-03, 6.6224000000e-03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 2,
              std::vector<double>{2.2658300000e-02, 1.3458950000e-01,
                                  3.6471810000e-01, 4.9041960000e-01,
                                  2.7138850000e-01},
              std::vector<double>{1.0483000000e+02, 3.0272000000e+01,
                                  1.0649000000e+01, 3.8696000000e+00,
                                  1.3239000000e+00});
            atom_bs.add_shell(chemist::ShellType::pure, 2,
                              std::vector<double>{1.0000000000e+00},
        ...
        case(36): {
            atomic_basis_t atom_bs("aug-cc-pv(d+d)z", 36, 0.0, 0.0, 0.0);
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                1.9690000000e-04, 1.5286000000e-03, 7.9500000000e-03,
              ...
              std::vector<double>{
                6.8135880000e+05, 1.0212650000e+05, 2.3243710000e+04,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 0,
              std::vector<double>{
                2.4900000000e-05, 1.9280000000e-04, 1.0149000000e-03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                1.5195000000e-03, 1.2742400000e-02, 6.3646500000e-02,
              ...
              std::vector<double>{
                4.4742700000e+03, 1.0605790000e+03, 3.4220810000e+02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                -6.2080000000e-04, -5.2212000000e-03, -2.6846300000e-02,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 1,
              std::vector<double>{
                1.7010000000e-04, 1.4064000000e-03, 7.3963000000e-03,
            ...
            atom_bs.add_shell(
              chemist::ShellType::pure, 2,
              std::vector<double>{2.1955700000e-02, 1.3216200000e-01,
                                  3.6334840000e-01, 4.9295820000e-01,
                                  2.6675600000e-01},
              std::vector<double>{1.1552530000e+02, 3.3465250000e+01,
                                  1.1830460000e+01, 4.3397710000e+00,
                                  1.5075240000e+00});
            atom_bs.add_shell(chemist::ShellType::pure, 2,
                              std::vector<double>{1.0000000000e+00},
