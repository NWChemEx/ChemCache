...
abs_t aug_dash_cc_dash_pv_oparen_d_plus_d_cparen_z_26() {
    ...
    shells.emplace_back(
      make_shell(pure_t::pure, 3, doubles_t{4.2224900000e-01, 7.7146800000e-01},
...
} // aug_dash_cc_dash_pv_oparen_d_plus_d_cparen_z_26
