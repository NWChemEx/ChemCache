...
MODULE_RUN(pv6z_atom_basis) {
    ...
    switch(Z) {
        case(1): {
            return atomic_basis_pt::wrap_results(rv, pv6z_1());
        }
        case(6): {
            return atomic_basis_pt::wrap_results(rv, pv6z_6());
        }
        case(7): {
            return atomic_basis_pt::wrap_results(rv, pv6z_7());
        }
        case(8): {
            return atomic_basis_pt::wrap_results(rv, pv6z_8());
        }
        default: {
